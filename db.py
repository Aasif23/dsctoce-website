...
def save_user(username, email, password,name,usn,branch):
    password_hash = generate_password_hash(password)
    users_collection.insert_one({'_id': username,'name':name, 'email': email, 'password': password_hash,'usn':usn,'branch':branch})
